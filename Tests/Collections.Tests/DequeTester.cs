...
#pragma warning disable 168
	internal class DequeTester
	{
		...
		private static void Main()
		{
			...
			GenericDequeTester.TestDeque(new Deque<int>());
			GenericDequeTester.TestDeque(Deque<int>.Synchronized(new Deque<int>()));
