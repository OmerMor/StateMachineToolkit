...
namespace Sanford.StateMachineToolkit
{
    ...
    internal class InitializeMethodBuilder
	{
        ...
        private StateInitializeBuilder stateInitializeBuilder;

        private GuardInitializeBuilder guardInitializeBuilder;

        private ActionInitializeBuilder actionInitializeBuilder;

        private TransitionInitializeBuilder transitionInitializeBuilder;

        private RelationshipInitializeBuilder relationshipInitializeBuilder;

        private HistoryInitializeBuilder historyInitializeBuilder;

        private InitialStateInitializeBuilder initialStateInitializeBuilder;
